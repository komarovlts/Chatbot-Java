...
public class Chatbot {
	...
	Scanner lecturaConsolaConversacion = new Scanner(System.in);
	    ...
	    "!beginDialog Cero".equals(mensajeUsuario) || "!beginDialog CERO".equals(mensajeUsuario)){
                ...
                else if(log.getUltimo(log.log).equals("|Chatbot evaluado|")){
                    beginDialog(0);
                    setChatbot(0);
                }
                else{
                ultimoMensaje = log.getUltimo(log.log);
                ...
                log.addLog(log.log, mensaje);
                log.addLog(log.log, ultimoMensaje);
                }
            }
            ...
            //End beginDialog.
            //Start Conversation.
            else if(log.getUltimo(log.log).equals("|Nombre|")){
                ...
                if(personalidad == 1){
                    ...
                    log.addLog(log.log, addMetaDatos("Usuario: "+ mensajeUsuario));
                    log.addLog(log.log, mensaje);
                }
                if(personalidad == 0){
                    mensaje = addMetaDatos("Chatbot: ¿Cómo estás "+ mensajeUsuario +"?");
                ...
                log.addLog(log.log, "|Respuesta1|");     
            }
            else if(log.getUltimo(log.log).equals("|Respuesta1|") && !"!beginDialog 0".equals(mensajeUsuario) && !"!beginDialog cero".equals(mensajeUsuario) &&
	    !"!beginDialog Cero".equals(mensajeUsuario) && !"!beginDialog CERO".equals(mensajeUsuario) && !"!beginDialog 1".equals(mensajeUsuario) && !"!beginDialog uno".equals(mensajeUsuario) &&
            ...
            !"!saveLog".equals(mensajeUsuario) && !"!loadLog".equals(mensajeUsuario)){
                ...
                log.addLog(log.log, addMetaDatos("Usuario: "+ mensajeUsuario));
                log.addLog(log.log, mensaje);   
                log.addLog(log.log, "|Respuesta2|");     
            }
            else if(log.getUltimo(log.log).equals("|Respuesta2|") && !"!beginDialog 0".equals(mensajeUsuario) && !"!beginDialog cero".equals(mensajeUsuario) &&
	    !"!beginDialog Cero".equals(mensajeUsuario) && !"!beginDialog CERO".equals(mensajeUsuario) && !"!beginDialog 1".equals(mensajeUsuario) && !"!beginDialog uno".equals(mensajeUsuario) &&
            !"!beginDialog Uno".equals(mensajeUsuario) && !"!beginDialog UNO".equals(mensajeUsuario) && !"!beginDialog".equals(mensajeUsuario) &&  !"!rate 1".equals(mensajeUsuario) &&
            !"!rate 2".equals(mensajeUsuario) && !"!rate 3".equals(mensajeUsuario) && !"!rate 4".equals(mensajeUsuario) && !"!rate 5".equals(mensajeUsuario) && !"!endDialog".equals(mensajeUsuario) &&
            !"!saveLog".equals(mensajeUsuario) && !"!loadLog".equals(mensajeUsuario)){
                ...
                log.addLog(log.log, addMetaDatos("Usuario: "+ mensajeUsuario));
                log.addLog(log.log, mensaje);   
                log.addLog(log.log, "|Respuesta3|");     
            }
            else if(log.getUltimo(log.log).equals("|Respuesta3|") && !"!beginDialog 0".equals(mensajeUsuario) && !"!beginDialog cero".equals(mensajeUsuario) &&
	    !"!beginDialog Cero".equals(mensajeUsuario) && !"!beginDialog CERO".equals(mensajeUsuario) && !"!beginDialog 1".equals(mensajeUsuario) && !"!beginDialog uno".equals(mensajeUsuario) &&
            !"!beginDialog Uno".equals(mensajeUsuario) && !"!beginDialog UNO".equals(mensajeUsuario) && !"!beginDialog".equals(mensajeUsuario) &&  !"!rate 1".equals(mensajeUsuario) &&
            !"!rate 2".equals(mensajeUsuario) && !"!rate 3".equals(mensajeUsuario) && !"!rate 4".equals(mensajeUsuario) && !"!rate 5".equals(mensajeUsuario) && !"!endDialog".equals(mensajeUsuario) &&
            !"!saveLog".equals(mensajeUsuario) && !"!loadLog".equals(mensajeUsuario)){
                ...
                log.addLog(log.log, addMetaDatos("Usuario: "+ mensajeUsuario));
                log.addLog(log.log, mensaje);   
                log.addLog(log.log, "|Respuesta4|");     
            }
            else if(log.getUltimo(log.log).equals("|Respuesta4|") && !"!beginDialog 0".equals(mensajeUsuario) && !"!beginDialog cero".equals(mensajeUsuario) &&
	    !"!beginDialog Cero".equals(mensajeUsuario) && !"!beginDialog CERO".equals(mensajeUsuario) && !"!beginDialog 1".equals(mensajeUsuario) && !"!beginDialog uno".equals(mensajeUsuario) &&
            !"!beginDialog Uno".equals(mensajeUsuario) && !"!beginDialog UNO".equals(mensajeUsuario) && !"!beginDialog".equals(mensajeUsuario) &&  !"!rate 1".equals(mensajeUsuario) &&
            !"!rate 2".equals(mensajeUsuario) && !"!rate 3".equals(mensajeUsuario) && !"!rate 4".equals(mensajeUsuario) && !"!rate 5".equals(mensajeUsuario) && !"!endDialog".equals(mensajeUsuario) &&
            !"!saveLog".equals(mensajeUsuario) && !"!loadLog".equals(mensajeUsuario)){
            ...
            //Start rate.
                ...
                if(log.getUltimo(log.log).equals("|Fin de la Conversación|")){
                   rate(1);
                } 
                else{
                    System.out.println(advertencia);
                    log.addLog(log.log, addMetaDatos("Usuario: "+ mensajeUsuario));
                    log.addLog(log.log, addMetaDatos(advertencia));
                }
            }
    ...
    public void endDialog(int seed){
        ...
        log.addLog(log.log, "|Fin de la Conversación|");
    }
    ...
    public void rate(int notaUsuario){
        ...
        if(repeticiones == 7){
            ...
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 1 "));
        }
        else if(repeticiones == 5){
            evaluaciones.add("Evaluación de Chatbot: 2 ");
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 2 "));
        }
        else if(repeticiones == 3){
            evaluaciones.add("Evaluación de Chatbot: 3 ");
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 3 "));
        }
        else if(repeticiones == 2){
            evaluaciones.add("Evaluación de Chatbot: 4 ");
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 4 "));
        }
        else if(repeticiones == 0){
            evaluaciones.add("Evaluación de Chatbot: 5 ");
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 5 "));
        }
        else{
            evaluaciones.add("Evaluación de Chatbot: 0 ");
            log.addLog(log.log, addMetaDatos("Evaluación de Chatbot: 0 "));
        }
        evaluaciones.add("Evaluación de Usuario: " + notaUsuario);
        log.addLog(log.log, addMetaDatos("Evaluación de Usuario: " + notaUsuario));
        System.out.println("Chatbot: He sido evaluado exitosamente, ya puedes iniciar una nueva conversación.");
        log.addLog(log.log, addMetaDatos("Chatbot: He sido evaluado exitosamente, ya puedes iniciar una nueva conversación."));
        addDatosFinales();
    ...
    public void addDatosFinales(){
        ...
        log.addLog(log.log, "Nombre: "+ nuevoUsuario.nombreUsuario);
        log.addLog(log.log, "----Chatbot----");
        log.addLog(log.log, "Personalidad: "+ personalidad);
        log.addLog(log.log, "----Evaluaciones----");
        log.addLog(log.log, (String) evaluaciones.get(0));
